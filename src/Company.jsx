	...
	function sendQuery() 
	{
		...
		fetch(endpoint)
		  ...
		  .then(function(myJson) {
		    ...
		    var data1 = [];
	    	data1.push({x : "Postiive Posts", y: myJson["res"]["positive_post"]})
	    	data1.push({x : "Negative Posts", y: myJson["res"]["negative_post"]})
	    	setGraphData2(myJson["res"]["average_upvote"])
	    	setNodata(false)
		    console.log(data1);
		    setGraphData(data1);
		    console.log("asdf")
...
const genbar = () => 
{
	...
	return (
			...
			<XYPlot
                ...
                <XAxis />
                <YAxis />
                <VerticalBarSeries barWidth={0.5} data={genlineseries[0]} />
